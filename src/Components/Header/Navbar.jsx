...
const Navbar = () => {
  ...
  <div className="navbar-start">
    ...
    <Link className='flex gap-1 justify-center items-center bg-gradient-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent text-[1rem] font-medium' to='/'><img className='w-10' src={logo} alt="App Zone Logo" />App Zone</Link>
  </div>
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1 text-[1rem] font-medium">
      <NavLink className='mr-4' to='/'>Home</NavLink>
      <NavLink className='mr-4' to='/app'>App</NavLink>
